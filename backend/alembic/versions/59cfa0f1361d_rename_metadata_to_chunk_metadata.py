...
def upgrade() -> None:
    ...
    op.add_column(
        "document_chunks", sa.Column("document_id", sa.Integer(), nullable=False)
    )
    op.add_column(
        "document_chunks", sa.Column("chunk_metadata", sa.JSON(), nullable=True)
    )
    op.alter_column(
        "document_chunks",
        "created_at",
    ...
    op.create_index(
        op.f("ix_document_chunks_hash"), "document_chunks", ["hash"], unique=False
    )
    ...
    op.alter_column(
        "processing_tasks", "document_id", existing_type=mysql.INTEGER(), nullable=True
    )
    op.alter_column(
        "processing_tasks",
        "status",
    ...
    op.alter_column(
        "processing_tasks", "created_at", existing_type=mysql.DATETIME(), nullable=True
    )
    op.alter_column(
        "processing_tasks", "updated_at", existing_type=mysql.DATETIME(), nullable=True
    )
    op.create_index(
        op.f("ix_processing_tasks_id"), "processing_tasks", ["id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "processing_tasks", "updated_at", existing_type=mysql.DATETIME(), nullable=False
    )
    op.alter_column(
        "processing_tasks", "created_at", existing_type=mysql.DATETIME(), nullable=False
    )
    op.alter_column(
        "processing_tasks",
        "status",
    ...
    op.alter_column(
        "processing_tasks", "document_id", existing_type=mysql.INTEGER(), nullable=False
    )
    op.alter_column(
        "processing_tasks",
        "knowledge_base_id",
